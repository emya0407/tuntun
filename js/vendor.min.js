/*! jQuery v3.3.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function(e, t) {
  ...
  var E = function(e) {
    ...
    n = oe.support = {}, o = oe.isXML = function(e) {
      ...
      pseudos: {
        ...
        btn_empty: function(e) {
          for (e = e.firstChild; e; e = e.nextSibling)
            if (e.nodeType < 6) return !1;
          return !0
        },
        parent: function(e) {
          return !r.pseudos.btn_empty(e)
        },
        header: function(e) {
  ...
  w.extend({
    ...
    dequeue: function(e, t) {
      ...
      "inprogress" === i && (i = n.shift(), r--), i && ("fx" === t && n.unshift("inprogress"), delete o.stop, i.call(e, a, o)), !r && o && o.btn_empty.fire()
    },
    _queueHooks: function(e, t) {
      var n = t + "queueHooks";
      return J.get(e, n) || J.access(e, n, {
        btn_empty: w.Callbacks("once memory").add(function() {
    ...
    promise: function(e, t) {
      ...
      while (a--)(n = J.get(o[a], e + "queueHooks")) && n.btn_empty && (r++, n.btn_empty.add(s));
  ...
  w.extend({
    ...
    text: function(e) {
      return z(this, function(e) {
        return void 0 === e ? w.text(this) : this.btn_empty().each(function() {
  ...
  function ct(e, t, n) {
    var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t,
      ...
      g = e.nodeType && ae(e),
      y = J.get(e, "fxshow");
    n.queue || (null == (a = w._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, s = a.btn_empty.fire, a.btn_empty.fire = function() {
      a.unqueued || s()
    }), a.unqueued++, p.always(function() {
      p.always(function() {
        a.unqueued--, w.queue(e, "fx").length || a.btn_empty.fire()
      })
    }));
    for (r in t)
      if (i = t[r], it.test(i)) {
...
$.scrollLock = function() {
  ...
  function l() {
    var l = s.attr("style"),
      o = [],
      t = {};
    l && (o = l.split(/;\s/), $.each(o, function(l) {
      if (l) {
        var o = l.split(/\s:\s/);
  ...
  function o() {
    ...
    c || (r = {
      ...
      top: -r.scrollTop + "px"
    }), s.css(o), $(window).scrollLeft(0).scrollTop(0), c = !0)
  }

  function t() {
    c && (s.attr("style", $("<x>").css(n).attr("style") || ""), $(window).scrollLeft(r.scrollLeft).scrollTop(r.scrollTop), c = !1)
  }
  var s = $("html"),
    c = !1,
    r = {
    ...
    var t, o = "mCustomScrollbar",
      ...
      A = function(t) {
        var o = !1,
          a = !1,
          n = null;
        if (void 0 === t ? a = "#btn_empty" : void 0 !== e(t).attr("id") && (a = e(t).attr("id")), a !== !1 && void 0 !== R[a]) return R[a];
        if (t) {
          try {
